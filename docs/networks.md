...
## Mainnet \([https://network.thegraph.com](https://network.thegraph.com)\)
...
## Testnet \([https://testnet.thegraph.com/](https://testnet.thegraph.com/), Rinkeby\)

### Registration / Funding \(GRT\)

In order to register for the testnet and have testnet GRT distributed to you, please fill out the [testnet registration form](https://airtable.com/shrL1trS84Jf0aawP).
